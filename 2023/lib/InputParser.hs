...
import Data.Char (isAlpha, isControl, isDigit, isHexDigit, isSpace, isAlphaNum)
...
import Text.Megaparsec (Parsec, anySingle, between, choice, endBy, eof, manyTill, notFollowedBy, oneOf, parse, satisfy, sepBy, sepEndBy, some, someTill, try, (<?>))
import Text.Megaparsec.Char (char, hspace, hspace1, letterChar, newline, printChar, space, space1, string)
